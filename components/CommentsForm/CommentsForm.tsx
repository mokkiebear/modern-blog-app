            ...
            <div className="grid grid-cols-1 gap-4 mb-4">
                <div>
                    <input 
                        ...
                        value="true"
                    />
                    <label className="text-gray-500 cursor-pointer ml-2" htmlFor="storeData">Сохранить мое имя и email в этом браузере.</label>
                </div>
            </div>
            {error && <p className="text-xs text-red-500">Необходимо заполнить все поля, для того, чтобы оставить комментарий.</p>}
            <div className="mt-8">
                <button
                    type="button"
